...
public class HDFC implements IBank
{
 ...
 void withdrawing()
 {
  ...
  {
   throw new LowBalanceExceptions("The Amount tour trying to withdraw is making your bank balance lower than min balance so you can not withdraw that much amount");
  }
  else
  {
